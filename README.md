...
Run the python script, ensuring all dependencies are installed.
The script will capture video from your webcam, detect dog faces, and display the predicted emotion in real-time.
Press 'q' to quit.
Testing
